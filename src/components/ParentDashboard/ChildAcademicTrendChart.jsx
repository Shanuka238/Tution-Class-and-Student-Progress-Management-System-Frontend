...
const ChildAcademicTrendChart = ({ examResults = [] }) => {
          ...
          <Card
            title={
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <span>
                  Child Marks Over Time {selectedSubject !== "ALL" ? `(${selectedSubject})` : "per Term"}
                </span>
              </div>
            }
            bordered={false}
          ...
          <Card
            title={
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <span>
                  {selectedSubject !== "ALL" ? `${selectedSubject} Exam Breakdown` : "Subject Marks Comparison"}
                </span>
              </div>
            }
            bordered={false}
...
export default ChildAcademicTrendChart;
